  ...
  <div class="tp-banner" >
    <ul>
      <li data-transition="fade" data-slotamount="7" data-masterspeed="2000" data-saveperformance="on"  data-title="Ken Burns Slide">
        <!-- MAIN IMAGE -->
        <img src="<?= $images_path; ?>dummy.png"  alt="2" data-lazyload="<?= $images_path; ?>cust/slider/1/Cantract-Law.jpg" data-bgposition="right top" data-kenburns="off" data-duration="12000" data-ease="Power0.easeInOut" data-bgfit="115" data-bgfitend="100" data-bgpositionend="center bottom">
    ...
    <div style="float:left; margin-right:20px;">
      <a href="<?=get_site_url(); ?>/practice?page=about_us&view=rev_single_column" class="pull-left tp-caption lfb tp-resizeme rs-parallaxlevel-0"
        ...
        <a href="<?=get_site_url(); ?>/practice?page=contact_us" class="tp-caption lfb tp-resizeme rs-parallaxlevel-0"
          ...
          transition: .4s;
          ;"
          border="0" name="submit" alt="PayPal – The safer, easier way to pay online." class="button btn-border btn-small"><i class="icon-bag"></i>&nbsp; GET IN TOUCH
        </a>
      </div>
    </li>
    <!-- IMAGE 3  -->
    <li data-transition="fade" data-slotamount="7" data-masterspeed="2000" data-saveperformance="on"  data-title="Ken Burns Slide">
      <!-- MAIN IMAGE -->
      <img src="<?= $images_path; ?>dummy.png"  alt="2" data-lazyload="<?= $images_path; ?>cust/slider/1/bg02.jpg" data-bgposition="right top" data-kenburns="off" data-duration="12000" data-ease="Power0.easeInOut" data-bgfit="115" data-bgfitend="100" data-bgpositionend="center bottom">
      <div class="tp-caption tentered_white_huge lft tp-resizeme" data-endspeed="300" data-easing="Power4.easeOut" data-start="400" data-speed="600" data-y="280" data-hoffset="0" data-x="center"
      style="    color: #fff;
      text-transform: uppercase;
      font-size: 40px;
